import InputDraftNotice from '../common/InputDraftNotice.jsx';

export default function DescriptiveInputNotice({ source, darkMode, categorical = false, hasResults, onGoResults, draft }) {
    return <div className={`mt-5 space-y-2 text-sm ${darkMode ? 'text-slate-300' : 'text-slate-700'}`}>
        ...
        <InputDraftNotice draft={draft} darkMode={darkMode} />
