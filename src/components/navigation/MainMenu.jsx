...
import { ArrowRight, Search, Book, LayoutGrid, BrainCircuit, Trophy } from 'lucide-react';
const MainMenu = ({ onSelect, darkMode }) => {
  const modes = [
    ...
    { id: 'jeopardy', title: 'Trivia Party', desc: 'Play Jeopardy in Competition, Practice, and Learn modes with tracked stats.', icon: Trophy, color: 'text-cyan-400', bg: 'bg-cyan-500/10' }
  ];
